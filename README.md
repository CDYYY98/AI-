...
个人中心的卡密兑换流程补上购买入口：用户可以从兑换区域直接打开购卡页面，拿到卡密后回到个人中心兑换灵感值，减少“先找链接、再回应用”的跳转成本。

- 个人中心卡密区增加“购买卡密”按钮，购买页会在新标签页打开，用户复制卡密后可以直接回到当前页面兑换。
- 购买入口直接打开链动小铺商品页，避免短链接预览页打断用户购买流程。
- 购买按钮会为链动小铺打开独立页面，方便桌面客户端保留当前个人中心兑换页。
- 首个 5000 灵感值卡密商品已准备好库存，适合先用小额卡密验证正式付费流程，再逐步接入更完整的自动支付链路。
