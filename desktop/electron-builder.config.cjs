...
const githubOwner = firstNonEmpty(process.env.AI_NOVEL_GITHUB_OWNER, "CDYYY98");
const githubRepo = firstNonEmpty(process.env.AI_NOVEL_GITHUB_REPO, "AI-");
...
module.exports = {
  ...
  extraResources: [
    ...
    {
      from: "build/resources/deploy.json",
      to: "deploy.json",
    },
    {
