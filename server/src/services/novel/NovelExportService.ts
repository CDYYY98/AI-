...
import {
  ...
  type NovelTxtRecord,
} from "./export/novelExportFormatting";
import {
  ...
  mapPipelineJob,
} from "./export/novelExportMappers";
import type { NovelExportBundle } from "./export/novelExportTypes";
    ...
    return {
      ...
      sections: {
        ...
        character: {
          ...
          timelines: buildExportTimelineGroups(novel.characters ?? [], characterTimelineRows),
        },
        outline: {
